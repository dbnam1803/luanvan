        ...
        <div class="details details2">
            <div class="recentOrders">
                <div class="cardHeader">
                    <h2>Tạo chi tiết sản phẩm mới</h2>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-7">
                            ...
                            <div class="alert alert-success d-flex justify-content-between" role="alert">
                                ...
                                <a href="./admin/product/{{$product->id}}/detail">xem danh sách chi tiết sản phẩm</a>
                            </div>
                            @endif
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="color" id="color" placeholder="Màu sắc" required>
                                @error('color')
                            ...
                            <button type="submit" class="btn btnAdd btnSaveProfile mt-30 ">Tạo</button>
                        </div>
                    </div>
